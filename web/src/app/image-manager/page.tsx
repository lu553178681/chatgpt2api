...
import { deleteImages, deleteManagedImages, fetchImageTags, fetchManagedImages, setImageTags, type ManagedImage } from "@/lib/api";
...
function ImageManagerContent() {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await deleteImages([deleteTarget.rel]);
